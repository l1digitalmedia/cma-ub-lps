...
$('.lp-pom-box').each(function() {  
  
  if (parseInt($(this).width()) >= 290) {
    this.style.boxShadow = "2px 4px 14px -8px rgba(1, 31, 75, 0.95)";
}
});  
  $("#lp-pom-button-4829").hover(function(){
      $("#lp-pom-box-6043").css("opacity", 1);
      $("#lp-pom-text-6044").css("opacity", 1);
      }, function(){
        $("#lp-pom-box-6043").css("opacity", 0);
        $("#lp-pom-text-6044").css("opacity", 0);
	});
