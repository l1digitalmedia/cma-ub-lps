...
$('.lp-pom-box').each(function() {  if (parseInt($(this).width()) >= 290) {
  ...
  document.getElementById("lp-pom-box-6334").style.boxShadow = "0px 0px 27px -4px rgba(255,149,0,1)";
  document.getElementById("lp-pom-box-6610").style.boxShadow = "0px 0px 27px -4px rgba(255,149,0,1)";
}
</script>
